...
def run_answer():
    ...
    parser.add_argument("--json_path", default="data/chunks.json", help="Path to the JSON file with chunk metadata.")
    ...
    answer = generate_answer(
        ...
        chunks_path=os.path.join(os.getcwd(), args.json_path),
        top_k=args.top_k,
        rerank=args.rerank,
    )
